    ...
    <div className="p-1 space-y-3 relative flex flex-col h-[calc(100vh-120px)]">
      ...
      <div className="flex gap-3 flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="bg-white rounded-lg shadow overflow-hidden flex-1 flex flex-col border border-gray-200">
            {/* Preview Header */}
            <div className="bg-gray-50 px-4 py-2.5 border-b border-gray-200">
              <p className="text-xs font-semibold text-gray-700">DOKUMEN SURAT KEPUTUSAN</p>
            </div>
