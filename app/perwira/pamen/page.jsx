...
export default function Pamen() {
    ...
    return (
        <div>
            <div className="mb-3">
                <div className="mb-3">
                    <p className="text-gray-800 text-md font-semibold">Data Perwira Menengah</p>
